...
import { UserCamara } from "../interface/user-camara";
import { Capacitor } from "@capacitor/core";
import { save, thumbsDownSharp } from 'ionicons/icons';
...
export class CamaraServiceService {
  ...
  public async agregarFoto() {
    ...
    const saveImagen = await this.saveFoto(foto)

    this.fotos.unshift(saveImagen);
  ...
  private async saveFoto(foto: Photo) {
  ...
  public async cargarFoto(){
    ...
    this.fotos = (value ? JSON.parse(value) : []) as UserCamara[];
